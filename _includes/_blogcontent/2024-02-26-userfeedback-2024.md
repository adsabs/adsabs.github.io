The virtual gathering of the [Astrophysics Data System Users Group (ADSUG)](../about/adsug/) on 16-17 November served as a pivotal moment in our ongoing transition from the Astrophysics Data System (ADS) to the [Science Explorer (SciX)](../scixblog/scix). A crucial precursor to this meeting was a user survey, offering a comprehensive view of the user community's perceptions, expectations, and concerns from the 248 survey respondents. 
...
<div class="text-center">
    <img class="img-thumbnail" src="{{ site.baseurl }}/blog/images/blog_2024-02-26_surveyresponse_1.png" alt="Charts showing ADS users with high usage frequency are also highly likely to recommend ADS to others" />
...
<div class="text-center">
    <img class="img-thumbnail" src="{{ site.baseurl }}/blog/images/blog_2024-02-26_surveyresponse_2.png" alt="Charts showing percentage of survey responses requesting improvements to ADS components and highly valued features" />
<br>
...
<div class="text-center">
    <img class="img-thumbnail" src="{{ site.baseurl }}/blog/images/blog_2024-02-26_surveyresponse_3.png" alt="Chart showing percentage of survey responses requesting expansion of ADS and SciX to additional subject areas" />
<br>
