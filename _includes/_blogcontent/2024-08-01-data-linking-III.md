...
<div class="text-center">
    <img class="img-thumbnail" src="{{ site.baseurl }}/blog/images/data_linking_III_f1.png" alt="Diagram of the PID graph from project FREYA in August 2020 showing connections between research objects" />
<br>
</div>
<br>
...
<div class="text-center">
    <img class="img-thumbnail" src="{{ site.baseurl }}/blog/images/data_linking_III_f2.png" alt="Bar chart showing estimated citation count by publication year for dataset records in SciX if all cited DOIs were indexed" />
<br>
...
<div class="text-center">
    <img class="img-thumbnail" src="{{ site.baseurl }}/blog/images/data_linking_III_f3.png" alt="SciX paper network showing clusters of publications citing the IVS data input to ITRF2014 dataset" />
<br>
...
<div class="text-center">
    <img class="img-thumbnail" src="{{ site.baseurl }}/blog/images/data_linking_III_f4.png" alt="Left: paper network for publications citing top 5000 VizieR catalogs. Right: Institutions and Bibgroups facets for citing publications" />
<br>
