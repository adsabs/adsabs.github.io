...
.section-title {
  ...
  margin-top: 10px;
  margin-bottom: 20px;
  color: #5FBFAE !important; /* Forces the teal color over theme defaults */
  font-weight: 700;
}
...
.testimonial-card {
  ...
  /* Creates a subtle gradient border using logo colors */
  border-image: linear-gradient(135deg, #5FBFAE, #2596be, #82c36b, #dbb64a) 1;
  border-radius: 1px; /* Note: Standard border-image clips border-radius on some browsers; using a crisp geometric card layout */
  padding: 22px;
  box-shadow: 0 4px 12px rgba(95, 191, 174, 0.08);
  display: flex;
...
.testimonial-card:hover {
  ...
  box-shadow: 0 12px 24px rgba(37, 150, 190, 0.15);
}
...
<section class="testimonials-section">
  <h2 class="section-title">Voices from the Global Research Community</h2>
  ...
  <div class="testimonials-grid">
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Valentina Villaflor</div>
        <div class="role">Astrophysics Researcher</div>
        <div class="affiliation">Max Planck Institute for Plasma Physics, Germany</div>
      </div>
    </div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Daniel Larrota</div>
        <div class="role">Planetary Remote Sensing Researcher</div>
        <div class="affiliation">University of Twente – ITC, The Netherlands</div>
      </div>
    </div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Catherine Rodriguez Tapalla</div>
        <div class="role">Geological Remote Sensing Researcher</div>
        <div class="affiliation">University of Twente – ITC, The Netherlands</div>
      </div>
    </div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Savannah Bindas</div>
        <div class="role">Air Quality Modelling Researcher</div>
        <div class="affiliation">University of Waterloo, Canada</div>
      </div>
    </div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Liz Olaya Calderon</div>
        <div class="role">Disaster Risk Management Researcher</div>
        <div class="affiliation">Eurac Research, Italy</div>
      </div>
    </div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Neelam Javed</div>
        <div class="role">Meteorology Researcher</div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Gisela Romero</div>
        <div class="role">Geospatial Data Engineer</div>
        <div class="affiliation">thriveGEO, Germany</div>
      </div>
    </div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Yang Qianqian</div>
        <div class="role">Air Pollution Researcher</div>
        <div class="affiliation">The University of Hong Kong, Hong Kong</div>
      </div>
    </div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Xiao Man</div>
        <div class="role">Remote Sensing Researcher</div>
        <div class="affiliation">The University of Hong Kong, Hong Kong</div>
      </div>
    </div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Evelyn Macdonald</div>
        <div class="role">Exoplanet Researcher</div>
        <div class="affiliation">University of Vienna, Austria</div>
      </div>
    </div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Lokesh Sahu</div>
        <div class="role">Ozone and VOC Researcher</div>
        <div class="affiliation">Physical Research Laboratory, India</div>
      </div>
    </div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Mansha Bashir</div>
        <div class="role">Geomatics Engineer</div>
        <div class="affiliation">IIT Ropar, India</div>
      </div>
    </div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Pushkar Bharadwaj</div>
        <div class="role">Seismology Researcher</div>
        <div class="affiliation">IISc Bengaluru, India</div>
      </div>
    </div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Sanket Bajad</div>
        <div class="role">Seismology Researcher</div>
        <div class="affiliation">IISc Bengaluru, India</div>
      </div>
    </div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Sourav Laha</div>
        <div class="role">Glaciology Researcher</div>
        <div class="affiliation">University of Liverpool, UK</div>
      </div>
    </div>
    ...
    <div class="testimonial-card">
      ...
      <div class="person">
        <div class="name">Christian Möstl</div>
        <div class="role">Head of the Austrian Space Weather Office</div>
        <div class="affiliation">Austrian Space Weather Office / Geosphere Austria</div>
      </div>
    </div>
