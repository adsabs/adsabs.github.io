NASA has long been one of the most visible leaders in providing Open Access (OA) to scientific data and publications. Supporting this goal is a crucial part of the mission of the Science Explorer (SciX).
...
As of the date of this blog (July 16, 2026), SciX contains 1.9 million records that link to PMC, and 1.4 million that link to Europe PMC. This set includes publications in more than 4,000 unique journals going back to 1894, across all [SciX collections](https://scixplorer.org/scixblog/scix-data-collections). As you might expect for a corpus of life sciences literature, more than half of these records are in the [SciX General Science collection](https://scixplorer.org/search?q=esources%3Apmc%2A+collection%3Ageneral&d=general), though about a third are in [Earth Science](https://scixplorer.org/search?q=esources%3Apmc*+collection%3Aearthscience&d=general), and about a quarter in [Physics](https://scixplorer.org/search?q=esources%3Apmc*+collection%3Aphysics&d=general). (Note that the SciX collections are not mutually exclusive; a publication can be in more than one.) There are even several thousand in the [Astronomy](https://scixplorer.org/search?q=esources%3Apmc%2A+collection%3Aastronomy&d=general) collection.
