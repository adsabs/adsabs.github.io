...
{% if include.ads == true %}
<figure>
   <img src="{{ site.baseurl }}/help/img/myads_setup_blank.png" alt="Screenshot of the myADS setup page showing options to create or import notification settings" class="img-responsive">
</figure>
{% endif %}
...
<figure>
   <img src="{{ site.baseurl }}/help/img/myads_arxiv.png" alt="Screenshot of the arXiv notification setup screen with category and keyword selection fields" class="img-responsive">
</figure>
<br>
...
<figure>
   <img src="{{ site.baseurl }}/help/img/myads_citations.png" alt="Screenshot of the citations notification setup screen with author name and ORCID ID fields" class="img-responsive">
</figure>
<br>
...
<figure>
   <img src="{{ site.baseurl }}/help/img/myads_keywords.png" alt="Screenshot of the keywords notification setup screen with a search query input field" class="img-responsive">
</figure>
<br>
...
<figure>
   <img src="{{ site.baseurl }}/help/img/myads_general.png" alt="Screenshot of the general notification setup widget showing a query name field and daily or weekly schedule options" class="img-responsive">
</figure>
<br>
...
<figure>
   <img src="{{ site.baseurl }}/help/img/myads_setup_blank.png" alt="Screenshot of the myADS setup page showing the Import button for importing Classic myADS settings" class="img-responsive">
</figure>
<br>
...
<figure>
   <img src="{{ site.baseurl }}/help/img/myads_begin_import.png" alt="Screenshot of the Classic myADS login screen with username, password, and mirror selection fields" class="img-responsive">
</figure>
<br>
