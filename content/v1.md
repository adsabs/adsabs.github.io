...
By default, all requests receive the **v1** [version](/v1/versions) of the API.
...
The source code of the ADS API gateway is accessible at https://github.com/adsabs/adsws.
