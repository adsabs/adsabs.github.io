---
title: Other Authentication Methods | ADS API
---
...
the existence of user data. Instead, the ADS API responds with `404 Not Found`.
...
To use Basic Authentication with the ADS API, simply send the username and
