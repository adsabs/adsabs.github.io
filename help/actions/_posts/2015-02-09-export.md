...
|--------------------------------------------------------------------------------------------------------------------------------	|------------------------------------------------------------------	|-----------	|----------------------	|--------------------------------------------------------------------------------------------------------------------------------	|-----------------------------------------------------------------------------------------	|
| text                                                                                                                           	| first author only if number of authors > 2 otherwise both authors 	| **%H**     |                      	| Henneken Kurtz and Accomazzi                                                                                                  	|  Henneken Muench Kurtz and Accomazzi                                                    	|
| symbol                                                                                                                         	| first author only if number of authors > 2 otherwise both authors 	| **%h**     |                      	|  Henneken Kurtz & Accomazzi                                                                                                    	|  Henneken Kurtz & Accomazzi                                                             	|
