...
|--------------------------------------------------------------------------------------------------------------------------------	|------------------------------------------------------------------	|-----------	|----------------------	|--------------------------------------------------------------------------------------------------------------------------------	|-----------------------------------------------------------------------------------------	|
| text                                                                                                                           	| first author only if number of authors > 2 otherwise both authors,<br>note these are separated by spaces not commas | **%H**     |                      	| -Henneken<br>-Kurtz and Accomazzi                                                                                                  	|  -Henneken Muench<br>-Kurtz and Accomazzi                                                    	|
| symbol                                                                                                                         	| first author only if number of authors > 2 otherwise both authors,<br>note these are separated by spaces not commas | **%h**     |                      	|  -Henneken<br>-Kurtz & Accomazzi                                                                                                    	|  -Henneken Muench<br>-Kurtz & Accomazzi                                                             	|
