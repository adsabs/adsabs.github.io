...
**j** | Journal | prints out the journal name if available; if an [AASTeX macro](../data_faq/journal-macros) for the journal is available, the macro is printed instead
