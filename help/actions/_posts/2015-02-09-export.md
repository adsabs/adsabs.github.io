...
* **Z**: Command format 
    ...
    There are two encoding options: global and field. As the name suggests specifying global encoding applies the encoding to all output field. Please see further down for explanation of field encoding.
