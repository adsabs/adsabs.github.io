...
|--------------------------------------------------------------------------------------------------------------------------------	|------------------------------------------------------------------	|-----------	|----------------------	|--------------------------------------------------------------------------------------------------------------------------------	|-----------------------------------------------------------------------------------------	|
| text                                                                                                                           	| first author only if number of authors > 2 otherwise both authors 	| **%H**     |                      	| -Henneken<br>-Kurtz and Accomazzi                                                                                                  	|  -Henneken Muench<br>-Kurtz and Accomazzi                                                    	|
| symbol                                                                                                                         	| first author only if number of authors > 2 otherwise both authors 	| **%h**     |                      	|  -Henneken<br>-Kurtz & Accomazzi                                                                                                    	|  -Henneken Muench<br>-Kurtz & Accomazzi                                                             	|
