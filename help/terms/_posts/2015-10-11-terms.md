...
Use of the SAO/NASA ADS API implies that the developer has read and agrees to the following terms and conditions:
  ...
  3. You won't try to make an entire copy of the data maintained and made available by the API, either by systematically downloading, or crawling our content. This again will lead to the suspension or deletion of your account.

  4. You should expect that the ADS may change, or update the API periodically. Unfortunately, this could lead to some of your services not working due to backwards-incompatability issues, and you should handle this appropriately. Please pay attention to our [news posts](http://adsabs.github.io/blog/) for possible information on API changes.
  ...
  7. We retain the possibility to share your contact info with people who want to contact you.
  ...
  9. To ensure our services run smoothly, and to build services based on usage from our developer community, you understand and acknolwedge that the ADS will collect certain private information about you. The information we collect is described in our [privacy policy](http://adsabs.github.io/help/privacy/), and if you do not agree with it, then you should stop using the ADS API.
