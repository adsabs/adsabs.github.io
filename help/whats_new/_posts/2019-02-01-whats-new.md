...
Applications are due by September 30. [Apply here](https://trustcareers.si.edu/en/postings/a7082567-bac9-4cbc-955f-bec97b685c3d).
   ...
   + **Final Blog Post in SciX Data Linking and Indexing Series by Edwin Henneken**<br>
     ...
     **[Part II: Linked Data](../../blog/data-linking-I)**<br>
     ...
     **[Part III: ](../../blog/data-linking-III)**<br>

   + **SciX Project Scientist Trains Coast Guard Cadets in Celestial Navigation**<br>
     In the 8th century BCE, [Homer wrote](https://www.perseus.tufts.edu/hopper/text?doc=Perseus%3Atext%3A1999.01.0136%3Abook%3D5%3Acard%3D262) “Gladly then did goodly Odysseus spread his sail to the breeze; and he sat and guided his raft skillfully with the steering-oar, nor did sleep fall upon his eyelids, as he watched the Pleiads, and late-setting Bootes, and the Bear, which men also call the Wain, which ever circles where it is and watches Orion, and alone has no part in the baths of Ocean. For this star Calypso, the beautiful goddess, had bidden him to keep on the left hand as he sailed over the sea. For seventeen days then he sailed over the sea, and on the eighteenth appeared the shadowy mountains of the land of the Phaeacians, where it lay nearest to him; and it shewed like unto a shield in the misty deep.”<br><br>
     Since ancient times, humans have relied on the stars, the Sun, the Moon, and the naked-eye planets to guide their way. [Celestial navigation](https://scixplorer.org/search?q=%22celestial+navigation%22&sort=score+desc&sort=date+desc&p=1) is an evolving set of techniques for determining one's position by observing celestial bodies. Familiarity with wind, tides, currents, and sea floor topography also play a role.<br><br>
     In the 20th century, electronic navigation took precedence to the extent that the [US Naval Academy](https://www.usna.edu/homepage.php) discontinued celestial navigation instruction in 1998. However, a growing recognition of [Global Positioning System (GPS)](https://scixplorer.org/search?q=full%3A%22Global+Positioning+System%22&sort=score+desc&sort=date+desc&p=1) vulnerabilities led to its [reinstatement in 2015](https://slate.com/technology/2015/10/u-s-naval-academy-reinstates-celestial-navigation-education.html). Today, these techniques are an important emergency back-up navigation system as well as an independent check in case of GPS spoofing.<br><br>
     Last month, SciX Project Scientist for Astrophysics [Jennifer Lynn Bartlett](../../about/team/team/jbartlett.html) sailed on the [USCG Barque Eagle](https://www.atlanticarea.uscg.mil/Area-Cutters/CGCEAGLE/) to train [US Coast Guard Academy](https://uscga.edu/) cadets in taking sights with a [sextant](https://scixplorer.org/abs/2023AAS...24117006Y/abstract) and computing their position from those measurements. Dr. Bartlett mastered this art and science when she led the [Software Products Division](https://aa.usno.navy.mil/) of the [US Naval Observatory](https://www.cnmoc.usff.navy.mil/usno/).
