...
/* Biology - Individual backdrop image */
...
[data-theme='dark'] .pillars-section h2 {
  color: #ffffff;
}

[data-theme='dark'] .pillars-intro {
  color: #cccccc;
}
...
[data-theme='dark'] .pillar-purpose {
  color: #cccccc;
}

[data-theme='dark'] .pillar-products h4 {
  color: #ffffff;
}

[data-theme='dark'] .pillar-products li {
  color: #cccccc;
}
...
[data-theme='dark'] .work-item h3,
[data-theme='dark'] .team-highlight h4 {
  color: #ffffff;
}
...
[data-theme='dark'] .discipline-showcase h2 {
  color: #ffffff;
}

[data-theme='dark'] .discipline-intro {
  color: #cccccc;
}
...
[data-theme='dark'] .discipline-description {
  color: #ffffff;
  text-shadow: 0 2px 4px rgba(0,0,0,0.9);
}

[data-theme='dark'] .discipline-stats .stat {
  background: rgba(255, 255, 255, 0.95);
  color: #000;
